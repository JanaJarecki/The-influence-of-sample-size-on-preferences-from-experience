...
\ \ \ E & l & 30 & 5.00 & 5.29 & -0.69 & 143\\
\ \ \ D & -- & -- & 4.00 & 4.60 & -- & --\\
Gamble ID 2 (\$-bet) &  &  &  &  &  & \\
\ \ \ E & xs & 6 & 4.00 & 4.33 & -0.71 & 129\\
...
baseline model described 1 participants best. Figure \ref{fig:fig2}
...
BIC\textsubscript{BASE}\(= 13\) (lower values indicate better fit).
...
(\added[id=jj2]{mean Pearson's} \(r\textsubscript{pred,obs} = 0.71\)),
