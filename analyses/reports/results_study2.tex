...
compared to description (\(M=4.83, SD=4.61\)), and the p-bets were
evaluated lower from experience compared (\(M=5.25, SD=4.94\)) to
description (\(M=4.32, SD=2.58\)), \(BF 0\) in favor of an ANOVA
including a gamble-type x condition interaction over a model with only
the main effects.. This D--E gap replicates the results from Study 1,
namely that participants valued gambles as if they overweight rare
events from description and from experience.
