...
\added[id=jj]{Unlike in Study 1 there was no difference between the evaluation of \$-bet gambles  ($M=4.69, SD=3.10$) and p-bet gambles ($M=5.25, SD=4.94$); the data equally supported a model including gamble type as predictor ($M_0$) and one without gamble type as predictor, $BF_{01} = 1.44$ (both models include by-participant and by-expected-value random effects and use the valuations as criterion).}
