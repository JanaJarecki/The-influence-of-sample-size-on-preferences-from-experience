...
\added[id=jj]{revealed that the data failed to strongly support a model with sample size as predictor ($M_0$) over a model without sample size $BF\textsubscript{01} = 2.71$.
}
