...
categories were 4.01 (\(SD = 1.23\)), 4.09, (\(SD = 1.14\)), 4.04
(\(SD = 1.19)\), and l = 4.16 (\(SD = 1.19\)). for sample size
categories xs, s, m, and l (respectively). Sample size did not influence
participants' confidence systematically:
