...
<<<<<<< HEAD
  Similarly, the confidence of relative-frequency-type learners did not show an effect of sample size on confidence ratings ($M = 4.14, 4.10, 4.07, 4.10$ for sample sizes xs, s, m, l, respectively; \textit{SD}s$=$ 1.17, 1.15, 1.08, 1.20, respectively; BF\textsubscript{excl,incl}$= 0.00348182551069965, FALSE$)}.
=======
  Similarly, the confidence of relative-frequency-type learners did not show an effect of sample size on confidence ratings ($M = 4.07, 4.14, 4.10, 4.10$ for sample sizes xs, s, m, l, respectively; \textit{SD}s$=$ 1.08, 1.17, 1.15, 1.20, respectively; BF\textsubscript{excl,incl}$= 0.003$)}.
>>>>>>> 5fe64ceee56effbf9c5e74783300ac7e2953afe7
