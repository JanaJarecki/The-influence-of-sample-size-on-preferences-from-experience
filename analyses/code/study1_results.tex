...
gambles and compares the experience and description condition. For
instance, in the experience condition people evaluated gamble 4, across
sample sizes xs, s, m, and l, by \(2.80, 2.91, 2.80, 2.95, 3.08\)
(respectively). Overall, the different sample sizes had no systematic
influence on participants' evaluations, which was confirmed by
statistical modeling by analyses of variance (ANOVA). The evaluations
are best predicted by a model that does not include sample size but a
combination of gamble type and expected value with a by-participant
random effect (Model 1), which outperformed a model including sample
size (\(BF_{10}= 430\)) and a model including a sample-size-gamble-type
...
\ \ \ E & l & 30 & 5.00 & 5.29 & -0.69 & 144\\
\ \ \ D & -- & -- & 4.00 & 4.60 & -- & --\\
Gamble ID 2 &  &  &  &  &  & \\
\ \ \ E & xs & 6 & 4.00 & 4.33 & -0.71 & 142\\
\ \ \ E & s & 12 & 4.00 & 4.31 & -0.69 & 725\\
\ \ \ E & m & 18 & 4.00 & 4.04 & -0.43 & 5\\
\ \ \ E & l & 36 & 4.00 & 3.99 & -0.37 & 2\\
\ \ \ D & -- & -- & 3.00 & 3.61 & -- & --\\
Gamble ID 3 &  &  &  &  &  & \\
\ \ \ E & xs & 7 & 6.00 & 7.56 & -0.99 & 4\\
\ \ \ E & s & 14 & 6.70 & 8.40 & -1.83 & 882\\
...
BASE (\textit{n}$=$NA) & -- & -- & -- & 0.47 (NA) & 0.30 (NA)\\
\bottomrule
\addlinespace
\end{tabular}
...
evaluations of \$-bets were higher than for p-bets (Gamble IDs 1--3
versus 4--6, Table \ref{tab:means_study1}), despite the gambles having
the same expected value. This finding is supported by comparing a linear
Bayesian regression model of gamble evaluations
