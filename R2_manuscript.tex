...
$$B_{\mathrm{BVU},t} \sim Beta(\theta_G + \delta n_G, \theta_0 + \delta n_t), \text{with } n_0 = t-n_t,$$
...
%the confidence of the learners that were classified by the best-fitting cognitive model showed strong differences with sample size
