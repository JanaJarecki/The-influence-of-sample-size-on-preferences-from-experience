...
\added[id==jj]{Learners that seemed to follow a relative frequency strategy did not change their evaluations and confidences substantially with sample size. However, against the prediction of the Bayesian model, there is also no evidence that the learners classified as Bayesians substantially changed their evaluations or their confidence in line with Bayesian principles. Only the trends of the effect point in the expected direction for the Bayesian learners.}
