...
output: html_document
  # github_document: # add this again
  #   css: css.css
  # html_document:
  #   toc: false
  #   toc_depth: 4
...
meta_info <- list(
  ...
  spatialCoverage = "NA", # take this out when having the info for studies 1 & 2 respectively
  temporalCoverage = "NA",
...
variables_explained <- list(
  ...
  # round = "Round number, consecutive number, independent of block or phase",
   ...
   value = "Respondents' evaluation response to the gamble", # 'to the gamble' necessary?
   ...
   confidence = "Respondents' self-reported confidence of their evaluation",
...
metadata(study1)$description <- "Choice data from the decision from experience experiment by Hoffart, Jarecki, Duthil & Rieskamp; possible outcomes known before sampling phase" # why was this left out of meta_info?
...
metadata(study2)$name <- "Study 2"
metadata(study2)$description <- "Choice data from the decision from experience experiment by Hoffart, Jarecki, Duthil & Rieskamp; possible outcomes learned during sampling phase" # why was this left out of meta_info?
